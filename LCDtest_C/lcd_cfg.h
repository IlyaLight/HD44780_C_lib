...
//-------------------------------
#define MCU_DDR						DDRD //порт  для упровляющих контактов

/* RS - Selects registers.
 * 0:	Instruction register (for write)
 * 0:	Busy flag + address counter (for read)
 * 1:	Data register (for write and read) */
#define LCD_RS_OUT					PORTD	/* Output register */
#define LCD_RS 						7u	/* Pin number */

/* R/W - Selects read or write.
 * 0:	Write
 * 1:	Read */
#define LCD_RW_OUT					PORTD	/* Output register */
#define LCD_RW						6u	/* Pin number */

/* E - Starts data read/write. */
#define LCD_E_OUT					PORTD	/* Output register */
#define LCD_E 	 					5u	/* Pin number */
...
#define LCD_D7_IN					PORTC	/* Input register */
